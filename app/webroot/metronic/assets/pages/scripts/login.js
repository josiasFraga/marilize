        ...
        form.validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success.hide();
                    warning.hide();
                    $("form#forgotpw .alert-danger span.message").html("Ocorreu um erro ao enviar requisição. (" + textStatus + " - " + errorThrown + ")")
                    error.show();
                    $("form#forgotpw button[type=submit]").html('<i class="fa fa-check"></i> Enviar').removeAttr('disabled');
                });
            }
        ...
        form.validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success.hide();
                    warning.hide();
                    $("form#verificacao .alert-danger span.message").html("Ocorreu um erro ao salvar requisição. (" + textStatus + " - " + errorThrown + ")")
                    error.show();
                    $("form#verificacao button[type=submit]").html('<i class="fa fa-check"></i> Enviar').removeAttr('disabled');
                });
            }
        ...
        form.validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success.hide();
                    warning.hide();
                    $("form#newpw .alert-danger span.message").html("Ocorreu um erro ao salvar requisição. (" + textStatus + " - " + errorThrown + ")")
                    error.show();
                    $("form#newpw button[type=submit]").html('<i class="fa fa-check"></i> Salvar').removeAttr('disabled');
                });
            }
