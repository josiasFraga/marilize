...
<table cellspacing="0" cellpadding="0">
    <tr>
        <th colspan="4" class="invernar">INVERNAR</th>
        <th colspan="3" class="gordo">GORDO</th>
...
<?php endforeach; ?>
    ...
    <tr>
        <td class="title strong">Mensal</td>
    ...
    <tr>
        ...
        <td class="mcolor1"><?php echo number_format($medias['invernar_quantidade'], 0, '', '.'); ?></td>
        <td class="mcolor1"><?php echo number_format($medias['invernar_comissao'], 2, ',', '.') ?></td>
        <td class="mcolor1"><?php echo number_format($medias['invernar_valor_vendas'], 2, ',', '.') ?></td>

        <td class="mcolor2"><?php echo number_format($medias['gordo_quantidade'], 0, '', '.'); ?></td>
        <td class="mcolor2"><?php echo number_format($medias['gordo_comissao'], 2, ',', '.') ?></td>
        <td class="mcolor2"><?php echo number_format($medias['gordo_valor_vendas'], 2, ',', '.') ?></td>

        <td class="mcolor3"><?php echo number_format($medias['geral_quantidade'], 0, '', '.'); ?></td>
        <td class="mcolor3"><?php echo number_format($medias['geral_comissao'], 2, ',', '.') ?></td>
        <td class="mcolor3"><?php echo number_format($medias['geral_valor_vendas'], 2, ',', '.') ?></td>
    </tr>
</table>
</div>