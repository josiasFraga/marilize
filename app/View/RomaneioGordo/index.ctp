        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase">Romaneios Gordo</span>
                </div>
                <div class="actions">
                    <a role="button" data-toggle="" href="<?php echo $this->Html->url(array('controller' => 'RomaneioGordo', 'action' => 'adicionar')) ?>" class="btn btn-circle btn-success">
                        <i class="fa fa-plus"></i> Incluir Romaneio </a>
                    <a role="button" data-toggle="" href="<?php echo $this->Html->url(array('controller' => 'RomaneioGordo', 'action' => 'imprimir')) ?>" class="btn btn-circle btn-default">
...
<?php $this->Html->script('/js/RomaneioGordo/index.js?v=1.0.3', array('block' => 'scriptBottom')); ?>
