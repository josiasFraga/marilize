...
<body>
    <h1 class="text-center">Relatório Contas à Pagar | Período de <?php echo date('d/m/Y', strtotime($pri)).' à '.date('d/m/Y', strtotime($ult));?></h1>
    <div style="width: 95%" class="container">
        <table class="table table-striped table-hover table-bordered">
            ...
            <?php endforeach; ?>
                <tr>
                    <td colspan="6" style="text-align: right; background-color: #34495e; color: #fff;">
                        <h5>Valor Total à Pagar: R$ <strong><span><?php echo number_format($valor_total, 2, ',', '.'); ?></span></strong></h5>
                    </td>
                </tr>
            </tbody>
        </table>
