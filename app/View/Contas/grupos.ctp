...
<div class="page-title">
	<h1>Grupos <small>administrar grupos</small></h1>
</div>
<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<div class="col-md-12">
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				<i class="font-dark"></i>
				<span class="caption-subject font-dark bold uppercase">Grupos</span>
			</div>
			<div class="actions">
				<a role="button" data-toggle="" href="<?php echo $this->Html->url(array('controller' => 'Contas', 'action' => 'adicionar_grupo')) ?>" class="btn btn-circle btn-default">
					<i class="fa fa-plus"></i> Incluir Grupo</a>
		...
		<div class="portlet-body">
			...
			<table class="table table-striped table-bordered table-hover table-checkable" id="table-grupos">
					<thead>
						<tr>
							<th class="table-checkbox" width="20px">
								<input type="checkbox" class="group-checkable" data-set="#table-grupos .checkboxes"/>
							</th>
							<th>Nome</th>
...
<?php $this->Html->script('/js/Contas/grupos.js?v=1.0.1', array('block' => 'scriptBottom')); ?>
