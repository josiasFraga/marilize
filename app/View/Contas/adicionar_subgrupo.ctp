...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-red-sunglo bold uppercase">Novo Subgrupo</span>
			<span class="caption-helper"></span>
		</div>
	</div>
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<form class="" action="#" method="post" enctype="multipart/form-data" id="novo-subgrupo" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="">
						<div class="input-icon right">
							<i class="fa"></i>
							<input type="text" class="form-control required" name="data[ContaSubgrupo][nome]" placeholder="Digite o nome do subgrupo" />
						</div>
					</div>
				</div>
...
$this->Html->script('/js/Contas/adicionar_subgrupo', array('block' => 'scriptBottom'));
