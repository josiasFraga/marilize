...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-red-sunglo bold uppercase">Alterar Grupo</span>
			<span class="caption-helper"></span>
		</div>
	</div>
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<form class="" action="#" method="post" enctype="multipart/form-data" id="alterar-grupo" autocomplete="off">
        
            <input type="hidden" class="form-control numeric required" name="data[ContaGrupo][id]" value="<?= $dados['ContaGrupo']['id'] ?>" />
				...
				<div class="form-group">
					...
					<div class="">
						<div class="input-icon right">
							<i class="fa"></i>
							<input type="text" class="form-control required" name="data[ContaGrupo][nome]" placeholder="Digite o nome da propriedade" value="<?= $dados['ContaGrupo']['nome'] ?>"/>
						</div>
					</div>
				</div>
...
$this->Html->script('/js/Contas/alterar_grupo', array('block' => 'scriptBottom'));
