...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-red-sunglo bold uppercase">Alterar Fazenda</span>
			<span class="caption-helper"></span>
		</div>
	</div>
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<form class="" action="#" method="post" enctype="multipart/form-data" id="alterar-fazenda" autocomplete="off">
        
            <input type="hidden" class="form-control numeric required" name="data[Fazenda][id]" value="<?= $dados['Fazenda']['id'] ?>" />
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="">
						<div class="input-icon right">
							<i class="fa"></i>
							<input type="text" class="form-control required" name="data[Fazenda][nome]" placeholder="Digite o nome da propriedade" value="<?= $dados['Fazenda']['nome'] ?>"/>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="">
						<div class="input-icon right">
							<i class="fa"></i>
							<input type="text" class="form-control" name="data[Fazenda][ie]" placeholder="Digite a IE da propriedade" value="<?= $dados['Fazenda']['ie'] ?>"/>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="">
						<div class="input-icon right">
							<i class="fa"></i>
							<input type="text" class="form-control" name="data[Fazenda][localizacao]" placeholder="Digite a localização da propriedade" value="<?= $dados['Fazenda']['localizacao'] ?>"/>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="">
						<div class="input-icon right">
							<i class="fa"></i>
                            <textarea  class="form-control" name="data[Fazenda][obs]" placeholder="Digite as observações da fazenda"><?= $dados['Fazenda']['obs'] ?></textarea>
						</div>
					</div>
				</div>
			</div>
...
$this->Html->script('/js/Fazendas/alterar', array('block' => 'scriptBottom'));
