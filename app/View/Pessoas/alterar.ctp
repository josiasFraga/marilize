<div class="modal fade" id="modalEditLocalidade" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- BEGIN FORM-->
                <form class="" action="#" method="post" enctype="multipart/form-data" id="alterar-localidade" autocomplete="off">
                    <div class="form-body">
                        ...
                        <input type="hidden" name="data[PessoaLocalidade][id]" />

                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    <label class="control-label">Descrição: <span class="required">*</span></label>
                                    <input type="text" class="form-control" name="data[PessoaLocalidade][descricao]" maxlength="250" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control numero" name="data[PessoaLocalidade][inscricao_estadual]" maxlength="50" />
                                </div>
                            </div>
                        </div><!-- ./row -->
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="data[PessoaLocalidade][estado]" maxlength="2" minlength="2" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="data[PessoaLocalidade][cidade]" maxlength="250" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="data[PessoaLocalidade][localidade]" maxlength="250" />
                                </div>
                            </div>
                        </div><!-- ./row -->
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button class="btn default" type="reset" data-dismiss="modal">Cancelar</button>
...
<div class="modal fade" id="modalEditBanco" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            ...
            <div class="modal-body">
                <!-- BEGIN FORM-->
                <form class="" action="#" method="post" enctype="multipart/form-data" id="alterar-banco" autocomplete="off">
                    <div class="form-body">
                        <div class="alert alert-danger display-hide">
                            <button class="close" data-close="alert"></button>
                            <span class="message">Por favor, revise os campos em vermelho.</span>
                        ...
                        <input type="hidden" name="data[PessoaBanco][id]" />

                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">Nome Banco: <span class="required">*</span></label>
                                    <input type="text" class="form-control" name="data[PessoaBanco][banco]" maxlength="250" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="data[PessoaBanco][titular]" maxlength="250" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control cpf" name="data[PessoaBanco][cpf]" maxlength="14" />
                                </div>
                            </div>
                        </div><!-- ./row -->
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="data[PessoaBanco][conta]" maxlength="50" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="data[PessoaBanco][agencia]" maxlength="50" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control cnpj" name="data[PessoaBanco][cnpj]" maxlength="18" />
                                </div>
                            </div>
                        </div><!-- ./row -->
                    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet-title tabbable-line">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase"> Alterar Pessoa </span>
                </div>
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form class="" action="#" method="post" enctype="multipart/form-data" id="alterar-pessoa" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="portlet-body form">
                                        <div class="form-body">
                                            <input type="hidden" name="data[Pessoa][id]" value="<?=$dados['Pessoa']['id']?>" />
                                                  ...
                                                  <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="data[Pessoa][tipo_pessoa_id]">
                                                            ...
                                                            <?php foreach ($listaPessoaTipo as $key => $value) { ?>
                                                                <?php if ($key != $dados['Pessoa']['tipo_pessoa_id']) { ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control cnpj" name="data[Pessoa][cnpj]" maxlength="18" placeholder="" value="<?=$dados['Pessoa']['cnpj']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control cpf" name="data[Pessoa][cpf]" maxlength="14" placeholder="" value="<?=$dados['Pessoa']['cpf']?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control cep" name="data[Pessoa][cep]" id="cep" maxlength="9" value="<?=$dados['Pessoa']['cep']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Cidade: <span class="required">*</span></label>
                                                        <input type="text" class="form-control" name="data[Pessoa][cidade]" id="cidade" maxlength="250" value="<?=$dados['Pessoa']['cidade']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label class="control-label">Estado (UF): <span class="required">*</span></label>
                                                        <input type="text" class="form-control" name="data[Pessoa][estado]" id="uf" maxlength="2" minlength="2" value="<?=$dados['Pessoa']['estado']?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="data[Pessoa][endereco]" maxlength="250" id="logradouro" value="<?=$dados['Pessoa']['endereco']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="data[Pessoa][numero]" maxlength="20" value="<?=$dados['Pessoa']['numero']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="data[Pessoa][complemento]" maxlength="250" id="complemento" value="<?=$dados['Pessoa']['complemento']?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="data[Pessoa][bairro]" id="bairro" maxlength="250" value="<?=$dados['Pessoa']['bairro']?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control phone" name="data[Pessoa][telefone1]" maxlength="15" value="<?=$dados['Pessoa']['telefone1']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control phone" name="data[Pessoa][telefone2]" maxlength="15" value="<?=$dados['Pessoa']['telefone2']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control phone" name="data[Pessoa][telefone3]" maxlength="15" value="<?=$dados['Pessoa']['telefone3']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control phone" name="data[Pessoa][telefone4]" maxlength="15" value="<?=$dados['Pessoa']['telefone4']?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="data[Pessoa][email]" maxlength="250" value="<?=$dados['Pessoa']['email']?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="data[Pessoa][observacoes]" rows="3"><?=$dados['Pessoa']['observacoes']?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="table-scrollable">
                                                        <table class="table table-striped table-bordered table-hover" id="table-localidades">
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($dados['localidades'] as $localidades) { ?>
                                                                <tr>
                                                                    <input type="hidden" id="l<?=$localidades['PessoaLocalidade']['id']?>" value='{"descricao":"<?=$localidades['PessoaLocalidade']['descricao']?>", "inscricao_estadual":"<?=$localidades['PessoaLocalidade']['inscricao_estadual']?>", "estado":"<?=$localidades['PessoaLocalidade']['estado']?>", "cidade":"<?=$localidades['PessoaLocalidade']['cidade']?>", "localidade":"<?=$localidades['PessoaLocalidade']['localidade']?>"}' />
                                                                    <td><?=$localidades['PessoaLocalidade']['descricao']?></td>
                                                                    <td><?=$localidades['PessoaLocalidade']['inscricao_estadual']?></td>
                                                                    <td><?=$localidades['PessoaLocalidade']['estado']?></td>
                                                                    <td><?=$localidades['PessoaLocalidade']['cidade']?></td>
                                                                    <td><?=$localidades['PessoaLocalidade']['localidade']?></td>
                                                                    <td>
                                                                        <a href="#" class="btn btn-icon-only red btn-remove" data-id="<?=$localidades['PessoaLocalidade']['id']?>" title="Excluir Localidade"><i class="fa fa-trash"></i></a>
                                                                        <a class='btn btn-info btn-icon-only btn-alterar' data-id="<?=$localidades['PessoaLocalidade']['id']?>" data-toggle="modal" href="#modalEditLocalidade" title="Alterar Localidade"><i class='fa fa-edit'></i></a>
                                                                    </td>
                                                                </tr>
                                                                <?php } ?>
                                                            </tbody>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <table class="table table-striped table-bordered table-hover" id="table-bancos">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($dados['bancos'] as $bancos) { ?>
                                                            <tr>
                                                                <input type="hidden" id="b<?=$bancos['PessoaBanco']['id']?>" value='{"banco":"<?=$bancos['PessoaBanco']['banco']?>", "titular":"<?=$bancos['PessoaBanco']['titular']?>", "conta":"<?=$bancos['PessoaBanco']['conta']?>", "agencia":"<?=$bancos['PessoaBanco']['agencia']?>", "cpf":"<?=$bancos['PessoaBanco']['cpf']?>", "cnpj":"<?=$bancos['PessoaBanco']['cnpj']?>"}' />
                                                                <td><?=$bancos['PessoaBanco']['banco']?></td>
                                                                <td><?=$bancos['PessoaBanco']['titular']?></td>
                                                                <td><?=$bancos['PessoaBanco']['conta']?></td>
                                                                <td><?=$bancos['PessoaBanco']['agencia']?></td>
                                                                <td><?=$bancos['PessoaBanco']['cpf'].' / '.$bancos['PessoaBanco']['cnpj']?></td>
                                                                <td>
                                                                    <a href="#" class="btn btn-icon-only red btn-remove" data-id="<?=$bancos['PessoaBanco']['id']?>" title="Excluir Banco"><i class="fa fa-trash"></i></a>
                                                                    <a class='btn btn-info btn-icon-only btn-alterar' data-id="<?=$bancos['PessoaBanco']['id']?>" data-toggle="modal" href="#modalEditBanco" title="Alterar Banco"><i class='fa fa-edit'></i></a>
                                                                    <a target="_BLANK" class='btn btn-success btn-icon-only' href="<?= $this->Html->url(['controller' => 'Pessoas', 'action' => 'imprimirConta', $bancos['PessoaBanco']['id']]) ?>" title="Imprimir Banco"><i class='fa fa-print'></i></a>
...
$this->Html->script('/js/Pessoas/alterar.js?v=1.0', array('block' => 'scriptBottom'));
