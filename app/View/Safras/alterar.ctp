...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<span class="caption-subject font-red-sunglo bold uppercase">Alterar Safra</span>
			<span class="caption-helper"></span>
		</div>
	</div>
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<form class="" action="#" method="post" enctype="multipart/form-data" id="alterar-safra" autocomplete="off">
            <input type="hidden" class="required" name="data[Safra][id]" value="<?php echo $dados['Safra']['id'] ?>" >
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="">
						<div class="input-icon right">
							<i class="fa"></i>
							<input type="text" class="form-control required" name="data[Safra][nome]" placeholder="Digite o nome do safra" value="<?php echo $dados['Safra']['nome'] ?>" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="control-label ">Período: <span class="required">*</span>
						...
						<div class="input-icon right">
							<i class="fa"></i>
							<input type="text" class="form-control required rangepicker" name="data[Safra][inicio_fim]" placeholder="Selecione o período da safra" value="<?php echo $dados['Safra']['periodo'] ?>"  />
						</div>
				</div>
...
$this->Html->script('/js/Safras/alterar', array('block' => 'scriptBottom'));
