...
<div class="modal fade bs-modal-sm" id="modalAddPagamento" role="basic" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form role="form" id="alterar-receber" method="post" enctype="multipart/form-data" action="">
...
<?php $this->Html->script('/js/ContasReceber/index.js?v=1.0.1', array('block' => 'scriptBottom')); ?>
